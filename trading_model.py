...
class TradingModel:
    def __init__(self):
        ...
        self.classifier = RandomForestClassifier(n_estimators=200, max_depth=10, min_samples_split=5, min_samples_leaf=1, random_state=42)
        
        # Модель для регрессии (уровень)
        self.regressor = RandomForestRegressor(n_estimators=200, max_depth=10, min_samples_split=5, min_samples_leaf=1, random_state=42)
